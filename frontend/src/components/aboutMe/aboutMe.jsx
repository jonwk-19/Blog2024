    ...
    <div>
      ...
      <section className="about-myself">
        <div className="content">
          ...
          <p>
            The intrigue of finding vulnerabilities and
            strengthening them. It is a field in which I am just beginning but
            without a doubt it is already part of me.
          </p>
          <br />
          <p>
            This is a small blog that
